...
//             <button
//               onClick={() => setUsePhone(false)}
//               className={`px-4 py-2 ${!usePhone ? 'bg-purple-600 text-white' : 'bg-gray-200'} rounded-l-lg`}
//             >
//               Email
//             </button>
//             <button
//               onClick={() => setUsePhone(true)}
//               className={`px-4 py-2 ${usePhone ? 'bg-purple-600 text-white' : 'bg-gray-200'} rounded-r-lg`}
//             >
//               Phone
//             </button>
//           </div>
...
//             </form>
//           ) : (
//             <form onSubmit={otpSent ? handlePhoneRegister : handleSendOtp} className="space-y-6">
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">
//                   Phone Number
//                 </label>
